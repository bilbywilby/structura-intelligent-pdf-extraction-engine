...
import { Sparkles, FileText, Shield, Zap, Layout, ArrowRight, BadgeCheck } from 'lucide-react';
              ...
              >
                <header className="mb-16 text-center max-w-3xl mx-auto">
                  ...
                  <p className="text-muted-foreground text-xl leading-relaxed mb-10">
                    ...
                    Privacy-focused and entirely in-browser.
                  </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-5xl">
                  <FeatureCard icon={<Layout className="w-6 h-6" />} title="Spatial Logic" description="Reconstructs flows and columns by analyzing spatial geometry." />
                  <FeatureCard icon={<Shield className="w-6 h-6" />} title="100% Private" description="Data never leaves your browser. Local-only processing." />
                  <FeatureCard icon={<Zap className="w-6 h-6" />} title="Intelligent OCR" description="Automatic fallback to Tesseract.js for scanned documents." />
                </div>
              </motion.div>
            ) : (
              <motion.div
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <Badge variant="secondary" className="bg-primary/5 text-primary border-primary/20 font-mono text-[10px] uppercase tracking-tighter">
                          Experimental OCR Active
                        </Badge>
                      </div>
                      <p className="text-sm text-muted-foreground">Mapping entities and spatial flow</p>
                    </div>
                  </div>
